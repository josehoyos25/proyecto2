...
function ActualizarActividad({ fetchData, actividad }) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            await axiosClient.put(`http://localhost:3000/actividades/actualizarAct/${actividad.id_actividad}`, formData).then((response) => {
                fetchData();
